...
Getting started
=========================
An example Jupyter notebook describing usage options can be found in the `examples <https://github.com/ACCESS-NRI/MED-live-diagnostics/blob/main/docs/examples/example_notebook.ipynb>`_ directory.
