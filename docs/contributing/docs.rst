...
* Adding examples of Model Live Diagnostics being used for real live monitoring or analyses
...
Contributions to documentation should be submitted via pull requests to the Model Live Diagnostics
`core repository <https://https://github.com/ACCESS-NRI/MED-live-diagnostics>`_. Follow the steps in the :ref:`code` 
section.
